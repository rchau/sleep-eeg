...
def find_max_amplitude (DATA, srate):
    ...
    for patient_eeg in DATA:
        ...
        for stage in range(1,4): #stages 1,2 & 3  (3 combined with 4)
...
def max_frequency(amplitudes, frequencies):
    ...
    reasonable_limiter = np.where(frequencies_with_amplitudes_above_threshold < 55)
    reasonable_frequencies_with_amplitudes_above_threshold = frequencies_with_amplitudes_above_threshold[reasonable_limiter]
